...
const downloadLinks = bookIds.map((id) => {
  ...
  const downloadUrl = `${book.apiEndpoint}`;
...
console.log(downloadLinks)
  ...
  <div style="margin:auto;background: #F7EDE2; width: 90%; border-radius: 7px; font-family: 'Poppins', sans-serif;">
    ...
    Cliquez sur <span style="color: #FF4D6D;">le lien de votre ebook</span> pour le télécharger. Une fois téléchargé, extrayez les fichiers pour accéder au PDF.
</p>
